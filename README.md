...
```code
git clone https://github.com/aouwalitshikkha/Django-Course-Bangla.git
```
কিংবা উপরের কর্নারের কোড বাটন থেকে নিচের স্ক্রিনশটের মত ডাউনলোড করে নিন 

![Download Github](others/images/pic-1.jpg)
